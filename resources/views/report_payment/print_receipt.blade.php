        ...
        <div class="row">
            ...
            @if ($date_check < $originalDate)
                <table class="table-borderless" width="98%">
                    ...
                    <tr style="font-size: 16px;"><td class="text-left"><div style="margin-left: 20px;">สำนักงานใหญ่ : 30/15 หมู่ที่ 7 ตำบลแม่เหียะ อำเภอเมืองเชียงใหม่ จังหวัดเชียงใหม่</div></td></tr>
                    <tr style="font-size: 16px;"><td class="text-left"><div style="margin-left: 20px;">เลขประจำตัวผู้เสียภาษี : 0505557011329	</div></td></tr>
    ...
    <div class="container-fluid">
        ...
        <div class="table-responsive">
            <table class="table table-bordered mt-4">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center"  colspan="2"><br>{{ number_format($result->Price,2) }}<br><br><br><br></td>
                    </tr>
                    <tr>
                        <td><td colspan="2" class="text-center"> {{$customer_price}} </td></td>
                        <td colspan="2" class="text-center">จำนวนเงิน &emsp;</td>
                        <td class="text-center" colspan="2">{{ number_format($result->Price,2) }}</td>
                    </tr>
            ...
            <table>
                ...
                <tr>
                    @if ($date_check <$originalDate)
                        <td align="left" valign="top"><i class="far fa-check-square" style="font-size: 20px;"></i>&emsp;</td><td colspan="2">โอนเงินเข้าบัญชีเงินฝาก ธนาคารกสิกรไทย ชื่อบัญชี บจก.วี บียอนด์ ดีเวอลอปเม้นท์ <br> เลขที่บัญชี 039-2-87055-5</td>
                    @else
                ...
                <tr>
                    <td align="center"></td><td width="290">&emsp;- จำนวนเงิน &nbsp; {{ number_format($result->Price,2) }}  <span style="text-decoration:underline;"></span> &nbsp;  บาท </td><td>วันที่ : <span style="text-decoration:underline;">{{$Payment_Dates}}</span></td>
                </tr>
                <tr>
