            ...
            <tr>
                ...
                <td style="font-size:22px; text-align:justify;">
                    ...
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ข้อ 3. ผู้เช่าตกลงชำระค่าเช่าให้แก่ผู้ให้เช่าเป็นรายเดือน ทุกวันสิ้นเดือนของแต่ละเดือน
                        ในอัตราค่าเช่า <b>เดือนละ {{ $rents->price == null ? "0 บาท" : number_format($rents->price,2) }} ({{ $room_price == null ? "ศูนย์บาทถ้วน" : $room_price }})</b> ซึ่งจะเริ่มชำระค่าเช่าหลังทำการหักภาษี ณ ที่จ่ายและจะเริ่มชำระครั้งแรกภายใน <b> วันที่ {{ thaidate('j F พ.ศ. Y',$rents->date_firstget) }} </b> โดยผู้เช่าจะชำระค่าเช่าให้แก่ผู้ให้เช่าด้วยวิธีการโอนเงินค่าเช่าเข้าบัญชีเงินฝาก ของผู้ให้เช่า ในกรณีที่ผู้เช่าช่วงชำระค่าเช่า ล่าช้าพ้นจากกำหนดระยะเวลาในการชำระค่าเช่าตามสัญญานี้ ผู้เช่าจะดำเนินการติดตามทวงถาม และจัดเก็บค่าเช่าจาก ผู้เช่าช่วงให้กับผู้ให้เช่า เมื่อผู้เช่าช่วงชำระค่าเช่าแล้วผู้เช่าจะชำระ ค่าเช่าให้แก่ผู้ให้เช่าโดยไม่ถือเป็นการผิดสัญญา ในกรณี ผู้เช่าช่วงยกเลิกสัญญาเช่าก่อนครบกำหนดระยะเวลาผู้เช่า จะดำเนินการแจ้งผู้ให้เช่าทราบโดยเร็ว
                    </p>
        ...
        <table border="0" width="100%">
            <tr>
                <td style="font-size: 22px; text-align:justify;">
                    ...
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5.3 ผู้เช่ามีหน้าที่ดูแลรักษา และซ่อมแซมห้องชุดเสมอด้วยวิญญูชน จะพึงสงวนรักษาทรัพย์สินของตนเองโดยทุน ทรัพย์ของผู้เช่าเอง เว้นแต่การชำรุดทรุดโทรมที่เกิดขึ้นตามสภาพของห้องชุดจนถึงขนาดต้องซ่อมแซมใหญ่
                        รวมไปถึงการ ชำรุดทรุดโทรมของอุปกรณ์ภายในห้องที่เกิดขึ้นตามสภาพโดยเสื่อมตามกาลเวลาของการใช้งานผู้ให้เช่า จึงเป็นผู้รับผิดชอบ ในค่าใช้จ่ายสำหรับการซ่อมแซมนั้น
                    </p>
        ...
        <table border="0" width="100%">
            <tr>
                <td style="font-size: 22px; text-align:justify;">
                    ...
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;บรรดาหนังสือจดหมาย หรือคำบอกกล่าวใดๆ ที่คู่สัญญาฝ่ายหนึ่งฝ่ายใดส่งให้คู่สัญญาอีกฝ่ายหนึ่งไปยังสถานที่ ที่ระบุไว้ข้างต้น หรือตามที่อยู่ที่คู่สัญญาได้แจ้งเปลี่ยนแปลงให้อีกฝ่ายหนึ่งทราบในภายหลังถ้าได้ส่งทางไปรษณีย์ลงทะเบียน
                    ให้ถือว่าได้รับแล้วเว้นแต่ฝ่ายที่จะต้องได้รับคำบอกกล่าวพิสูจน์ได้ว่าไม่จงใจที่จะหลีกเลี่ยงรับหนังสือบอกกล่าวคู่สัญญาทุกฝ่าย ยินยอมผูกพันให้ถือว่าหนังสือหรือคำบอกกล่าวนั้นได้ส่งให้คู่สัญญาแต่ละฝ่ายโดยชอบแล้ว</p>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;หากผู้เช่า ประสงค์จะยกเลิกสัญญาเช่าฉบับนี้ต้องทำการบอกกล่าวยกเลิก
                        สัญญาเช่าไปยังผู้ให้เช่าก่อนเป็นระยะเวลา ไม่น้อยกว่า 15 วันและจะต้องส่งมอบห้องชุดคืนภายใน 15 วันนับแต่วันที่ผู้ให้เช่าทราบหรือถือว่าทราบการบอกกล่าวยกเลิก สัญญาเช่า</p>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ข้อ 9. การผิดสัญญา
                    </p>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;หากคู่สัญญาฝ่ายหนึ่งฝ่ายใดไม่ปฏิบัติตามสัญญานี้ข้อหนึ่งข้อใด คู่สัญญาอีกฝ่ายหนึ่งมีสิทธิตักเตือนให้อีกฝ่ายนั้นทราบ หากฝ่ายนั้นยังไม่ปฏิบัติตาม หรือแก้ไขภายในเวลาที่กำหนด อีกฝ่ายหนึ่งมีสิทธิ บอกเลิกสัญญานี้ได้ และมีสิทธิเรียกค่า เสียหาย ค่าปรับ พร้อมดอกเบี้ยจากความเสียหายหรือจากการผิดนัด ดังกล่าวในอัตราร้อยละ 15 ต่อปี หรือฟ้องร้อง ต่อศาลให้บังคับตามสัญญานี้
                    </p>
                    
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;สัญญานี้ทำขึ้นรวมสองฉบับมีข้อความตรงกัน ต่างฝ่ายต่างยึดถือไว้ฝ่ายละฉบับ คู่สัญญาทั้งสองฝ่ายได้อ่าน ฟังและ เข้าใจข้อความแห่งสัญญานี้ดีแล้ว เห็นว่าถูกต้องตามเจตนาจึงลงลายมือ ชื่อและประทับตราไว้เป็นสำคัญ ต่อหน้าพยาน
                    </p>
                </td>
            </tr>
        </table>
