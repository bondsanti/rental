        ...
        <table border="0" width="100%">
            ...
            <tr>
                <td style="font-size:22px; text-align:justify;">
                    ...
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;กรณีตัวแทนจัดหาผู้เช่าเข้าทำสัญญาเช่า หรือต่อระยะเวลาเช่าเพิ่มเติม กับผู้ให้สัญญาสำเร็จ ผู้ให้สัญญาตกลง ชำระค่าตอบแทนให้แก่ตัวแทน เท่ากับอัตราค่าเช่าหนึ่งเดือนที่ผู้ให้สัญญาได้รับจากผู้เช่า สำหรับการเช่าที่ผู้เช่าทำการเช่า เป็นระยะเวลา 1 (หนึ่ง) ปี และ จ่ายค่าบริการอื่นๆ อีก ตามข้อตกลง (ถ้ามี)
        ...
        <table border="0" width="100%">
            <tr>
                <td style="font-size: 22px; text-align:justify;">
                    ...
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;7.3 หากคู่สัญญาฝ่ายหนึ่งฝ่ายใด ไม่ปฏิบัติตามสัญญานี้ ข้อหนึ่งข้อใด คู่สัญญาฝ่ายมิได้ปฏิบัติผิดสัญญา อาจมีหนังสือแจ้งให้อีกฝ่ายหนึ่งทราบ เพื่อให้ปฏิบัติให้ถูกต้องตามสัญญา ภายในระยะเวลาที่กำหนด
                    </p>
                    ...
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;7.6 ผู้ให้สัญญาตกลงมอบอำนาจให้ตัวแทนมีอำนาจลงนาม ในสัญญาเช่ากับผู้เช่าแทนผู้ให้สัญญาตลอดจนมี อำนาจเต็มในการเจรจาอัตราค่าเช่าและเงื่อนไขต่างๆ ได้ทุกประการ โดยผู้ให้สัญญาให้ถือว่าการกระทำของตัวแทน ตามขอบวัตถุประสงค์แห่งสัญญานี้ เป็นเสมือนการกระทำของผู้ให้สัญญาเอง</p>
