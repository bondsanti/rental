        ...
        <table border="0" width="100%">
            ...
            <tr>
                <td style="font-size: 22px; text-align:justify;">
                    ...
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ข้อ 2. เพื่อเป็นประกันในการปฏิบัติตามสัญญา ผู้เช่าช่วงตกลงมอบเงินประกันการเช่าจำนวนเงิน <b>{{ $rents->price_insurance == null ? "0 บาท" : number_format($rents->price_insurance, 2) }} ({{ $price_insurance == null ? "ศูนย์บาท" :  $price_insurance }})</b> ตามหนังสือสัญญาทรัพย์สินและอุปกรณ์ตกแต่งห้อง <b>สัญญาเลขที่ {{ $rents->code_contract_old ?? ''}} </b> 
                        ฉบับลงวันที่ <b>{{ thaidate('j F พ.ศ. Y',$rents->print_contract_manual) }}</b> และผู้ให้เช่าช่วงได้รับเงินจำนวนดังกล่าวแล้วในวันทำสัญญาฉบับนี้ ถ้าผู้เช่าช่วง เช่าครบตามที่สัญญากำหนดไว้ และมิได้มีหนี้ค้างชำระ หรือภาระผูกพันใดๆ ตามสัญญาผู้ให้เช่าช่วงจะคืนเงินประกัน
                        สัญญานี้ให้แก่ผู้เช่าโดยไม่มีดอกเบี้ย หากมีความเสียหายเกี่ยวกับทรัยพ์สินและ อุปกรณ์ตกแต่งห้องชุด หรือไม่ปฏิบัติตามสัญญาเช่าช่วงห้องชุด ผู้เช่าช่วง ยินยอมให้ผู้ให้เช่าหักชำระค่าเสียหายนั้นออกจาก เงินประกันสัญญา ค่าเช่าที่ค้างชำระ และคืนเงินส่วนที่เหลือโดยไม่มี ดอกเบี้ยให้ หลังจากที่ได้หักเป็นค่าใช้จ่ายหรือค่าเสียหายอย่างใดๆ อันเกิดขึ้นแก่ทรัพย์สินที่ประกันแล้วภายใน 30 (สามสิบ) วัน นับจากวันที่ผู้ให้เช่าได้รับมอบครอบครองทรัพย์สินและ อุปกรณ์ตกแต่งห้องชุดเรียบร้อยแล้ว
                    </p>
        ...
        <table border="0" width="100%">
            <tr>
                <td style="font-size: 22px; text-align:justify;">
                    ...
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;สัญญานี้ทำขึ้นเป็นสองฉบับมีข้อความถูกต้องตรงกันทุกประการ คู่สัญญาได้อ่านฟังและเข้าใจข้อความแห่งสัญญานี้ ดีแล้วและเห็นว่าถูกต้องตามเจตนา จึงลงลายมือชื่อและประทับตราไว้เป็นสำคัญต่อหน้าพยาน</p>
                </td>
            </tr>
        </table>
        <div class="page-break"></div>
